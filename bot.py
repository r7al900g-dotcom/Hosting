...
OWNER_ID = int(os.getenv('OWNER_ID', 8477921435))
ADMIN_ID = int(os.getenv('ADMIN_ID', 8477921435))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', 'devilfiles1')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'devilfiles1')
...
if __name__ == '__main__':
    ...
    while True:
        try:
            bot.infinity_polling(logger_level=logging.INFO, timeout=20, long_polling_timeout=10)
